...
export default function DraftsPage() {
  ...
  const handleDownloadImage = (imageUrl: string | null, id: string) => {
    downloadImageFile(imageUrl, `linkedin-graphic-${id.substring(0, 6)}`);
  };
  ...
  // Publish Post & Redirect to /published tab
    ...
    <div className="max-w-7xl mx-auto space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-slate-400 mt-1">
            Your saved stock of approved LinkedIn post drafts ready for manual publishing.
          </p>
        </div>
      ...
      {loading ? (
        ...
        <div className="glass-panel p-12 rounded-2xl text-center border border-dashed border-slate-800">
          ...
          <h3 className="text-lg font-semibold text-white">No drafts in stock</h3>
          <p className="text-sm text-slate-400 max-w-sm mx-auto mt-1 mb-6">
            Run the Content Studio Pipeline to generate, review, and save high-performing post drafts.
          </p>
          <Link
            href="/"
          ...
          >
            <Sparkles className="w-4 h-4" /> Start Pipeline
          </Link>
        </div>
      ) : (
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <div key={post.id} className="glass-card rounded-2xl p-5 border border-slate-800/90 flex flex-col justify-between space-y-4 hover:border-slate-700 transition-all">
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span className="px-2.5 py-1 rounded-lg bg-amber-500/10 border border-amber-500/20 text-amber-400 text-[11px] font-bold uppercase tracking-wider">
                    Draft
                  </span>
              ...
              <div className="pt-3 border-t border-slate-800/80 space-y-2">
                ...
                <div className="flex items-center justify-between gap-2">
                  ...
                  <button
                    ...
                    title="Edit Full Post Copy & Image"
                  >
                  ...
                  <button
                    ...
                    className="p-2 text-slate-500 hover:text-rose-400 hover:bg-rose-500/10 rounded-xl border border-slate-800 transition-colors"
                    title="Delete Draft"
                  >
                ...
                <button
                  ...
                  className="w-full py-2.5 bg-emerald-600 hover:bg-emerald-500 disabled:opacity-50 text-white font-semibold text-xs rounded-xl shadow-lg shadow-emerald-600/20 flex items-center justify-center gap-1.5 transition-all"
                >
                  ...
                  <span>Publish (Move to Published Tab)</span>
                </button>
              </div>
            </div>
          ))}
          ...
          <div className="glass-panel w-full max-w-2xl rounded-xl sm:rounded-2xl border border-slate-700 shadow-2xl p-4 sm:p-6 space-y-4 sm:space-y-5 max-h-[95vh] overflow-y-auto">
            ...
            <div className="flex items-center justify-between border-b border-slate-800 pb-3">
              <h3 className="text-base font-bold text-white flex items-center gap-2">
                <Edit3 className="w-4 h-4 text-blue-400" /> Edit Draft Post
              </h3>
              <button
