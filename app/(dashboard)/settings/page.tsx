...
export default function SettingsPage() {
  ...
  const handleSubscribePush = async () => {
    ...
    try {
      ...
      if (saveRes.ok) {
        setPushSubscribed(true);
        setPushMessage('Successfully subscribed to Daily Reminders! You will get native notifications on your mobile/desktop panel.');
      } else {
  ...
  const handleUnsubscribePush = async () => {
    ...
    try {
      ...
      setPushMessage('Unsubscribed from Daily Reminders.');
    } catch (err: any) {
