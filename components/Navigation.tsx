...
export default function Navigation({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-[#0b0f19] text-slate-100">
      ...
      {/* Mobile Top Header */}
      <header className="md:hidden flex items-center justify-between px-4 py-3 bg-[#0f172a]/90 backdrop-blur-md border-b border-slate-800 sticky top-0 z-40">
        <div className="flex items-center gap-2.5">
          ...
          <span className="font-bold text-sm text-white">LinkedIn Studio</span>
        </div>
